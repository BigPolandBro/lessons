...
class TestSimpleGraph(unittest.TestCase):
    ...
    def test_bfs(self):
        for a in [0, 1, 2, 3, 4, 5, 7]:
            for b in [6, 8, 9]:
                self.assertEqual(self.graph.BreadthFirstSearch(a, b), self.graph.IndexListToVertexList([]))
        
        for a in range(0, 10):
            self.assertEqual(self.graph.BreadthFirstSearch(a, a), self.graph.IndexListToVertexList([a]))
            
        for a in range(0, 10):
            for b in range(0, 10):
                if self.graph.IsEdge(a, b):
                    #print(a, b, self.graph.IsEdge(a, b))
                    self.assertEqual(self.graph.BreadthFirstSearch(a, b), self.graph.IndexListToVertexList([a, b]))
        ...
        self.assertEqual(self.graph.BreadthFirstSearch(0, 4), self.graph.IndexListToVertexList([0, 2, 4]))
        self.assertEqual(self.graph.BreadthFirstSearch(2, 7), self.graph.IndexListToVertexList([2, 5, 7]))
        self.assertEqual(self.graph.BreadthFirstSearch(7, 3), self.graph.IndexListToVertexList([7, 5, 1, 3]))
        self.assertEqual(self.graph.BreadthFirstSearch(7, 4), self.graph.IndexListToVertexList([7, 5, 2, 4]))
        self.assertEqual(self.graph.BreadthFirstSearch(0, 5), self.graph.IndexListToVertexList([0, 1, 5]))
        self.assertEqual(self.graph.BreadthFirstSearch(0, 7), self.graph.IndexListToVertexList([0, 1, 5, 7]))
        self.assertEqual(self.graph.BreadthFirstSearch(0, 3), self.graph.IndexListToVertexList([0, 3]))
        self.assertEqual(self.graph.BreadthFirstSearch(3, 7), self.graph.IndexListToVertexList([3, 1, 5, 7]))
